                            ...
                            <div class="card-body">
                                <div class="dash-widget-header">
                                    ...
                                    <div class="dash-count">
                                        <a href="#" class="count-title">Total des client</a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="dash-widget-header">
                                    ...
                                    <div class="dash-count">
                                        <a href="#" class="count-title">Total des commandes</a>
                                        <a href="#" class="count"> 14,628 F CFA</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="dash-widget-header">
                                    ...
                                    <div class="dash-count">
                                        <a href="#" class="count-title">Total des ventes </a>
                                        <a href="#" class="count"> 2,980 F CFA</a>
                                    </div>
                                </div>
                            </div>
                        </div>
