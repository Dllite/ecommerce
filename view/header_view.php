...
<head>
    <meta charset="utf-8">
    <title>Bayam Sellam - Votre plateforme de vente en ligne au Cameroun</title>
        ...
        <div class="row bg-secondary py-1 px-xl-5">
            <div class="col-lg-6 d-none d-lg-block">
                <div class="d-inline-flex align-items-center h-100">
                    ...
                    <a class="text-body mr-3" href="">Contactez-nous</a>
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="" class="text-decoration-none">
                    <span class="h1 text-uppercase text-primary bg-dark px-2">Bayam</span>
                    <span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">Sellam</span>
                </a>
            </div>
                    ...
                    <div class="navbar-nav w-100">
                        <div class="nav-item dropdown dropright">
                            ...
                            <div class="dropdown-menu position-absolute rounded-0 border-0 m-0">
                                <a href="" class="dropdown-item">Vetements Hommes</a>
                                <a href="" class="dropdown-item">Vetements Femmes</a>
                                <a href="" class="dropdown-item">Vetements Enfants</a>
                            </div>
                        </div>
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <span class="h1 text-uppercase text-dark bg-light px-2">Bayam</span>
                        <span class="h1 text-uppercase text-light bg-primary px-2 ml-n1">Sellam</span>
                    </a>
...
>>>>>>> a81a952db69863d719dc5cdfa8fd03b51bdad568
